...
draft: false
tags: ["AI", "AGI", "DeepSeek", "梁文锋"]
categories: ["AI"]
description: "DeepSeek 创始人梁文锋与投资人交流会文字稿，围绕 AGI 愿景、开源与商业化、组织方式、国产芯片和持续学习等核心议题展开。"
---
# 梁文锋投资人会议文字稿修正稿
...
- **愿景与克制**：愿景就是实现AGI，一切都为了这个努力，不以利润最大化为目标，只赚合理利润，越克制越能做成
- **开源与商业化**：开源是愿景的必然要求，六倍利润下开源与商业付费没有冲突，AI市场足够大
- **AGI 路线图**：语言模型 → CoT → Agent → 持续学习 → 自我迭代奇点 → 具身智能
- **唯一核心利益**：团队稳定性，其他一切都可以克制、可以让步
- **与美国的差距**：本质是算力资源差距（二十分之一算力，落后一到两年），人才无本质差距
- **国产芯片机遇**：CUDA 护城河正被瓦解（AI + TileLang + 专用芯片），一年内生态问题可解决
- **组织与决策**：愿景驱动、无 KPI、共识机制、正式工作不超过一半时间

通读下来，围绕一个中心两个基本点，中心是AGI，基本点是愿景和克制。
