...
![文件状态流转](/images/review/git-learning-notes/image-20260519231654227.webp)
...
![.gitignore 规则示例](/images/review/git-learning-notes/image-20260607131625607.webp)
...
![分支创建与切换](/images/review/git-learning-notes/image-20260520165749820.webp)
...
![合并冲突示例](/images/review/git-learning-notes/image-20260520205050765.webp)

合并时遵循"所有权思想"：谁负责哪部分代码，就由谁来解决相关冲突。

![合并所有权](/images/review/git-learning-notes/image-20260520202908268.webp)

## fast-forward vs --no-ff

当目标分支在分叉后没有新的提交时，Git 默认执行 fast-forward 合并：直接把目标分支指针快进到来源分支的位置，不生成合并 commit。

![fast-forward 合并](/images/review/git-learning-notes/image-20260704154805399.webp)
...
![本地与远程仓库关系](/images/review/git-learning-notes/image-20260617105016445.webp)

`origin/*` 这样的分支表示的是"追踪远程仓库的本地镜像"。它的作用是：当远程和本地发生冲突时，fetch 下来的远程提交不会直接覆盖你的本地提交，而是先放到 `origin/*` 上，让你有机会查看和处理。

![remote-tracking branch](/images/review/git-learning-notes/image-20260617110257745.webp)
...
![协作者视角](/images/review/git-learning-notes/image-20260617110943037.webp)
...
![fetch 操作示意](/images/review/git-learning-notes/image-20260704143043963.webp)

## push：推送本地提交

push 连接远程仓库，计算本地比远程多的 commit 并上传，尝试更新远程分支。

![push 流程](/images/review/git-learning-notes/image-20260704144628750.webp)

### push 被拒绝的情况

如果远程分支有本地没有的提交（远程分支不是本地的祖先），push 会被拒绝。这通常发生在别人已经推送了新提交，你需要先 fetch + 合并/变基后再 push。

![push 冲突](/images/review/git-learning-notes/image-20260704144829365.webp)
...
![pull 默认 merge](/images/review/git-learning-notes/image-20260704152244715.webp)
...
![pull --rebase 避免环](/images/review/git-learning-notes/image-20260704153624311.webp)

合并完成后，远程分支也会移动到最新位置：

![pull 之后远程分支移动](/images/review/git-learning-notes/image-20260704152454803.webp)

### 远程协作小结

![远程操作总结](/images/review/git-learning-notes/image-20260704164005930.webp)
...
![rebase 原理](/images/review/git-learning-notes/image-20260530163605155.webp)
...
![rebase 跟进主分支](/images/review/git-learning-notes/image-20260530163449560.webp)

具体操作：先在 feature 分支上 checkout 主分支（rebase 的目标），在中间处理可能出现的冲突，解决后提交，最后合并回主分支。

![rebase 详细过程](/images/review/git-learning-notes/image-20260530164629128.webp)

![rebase 提交重放](/images/review/git-learning-notes/image-20260530165304601.webp)

![rebase 完成后的历史](/images/review/git-learning-notes/image-20260530170632429.webp)
...
![stash 暂存示意](/images/review/git-learning-notes/image-20260607125406925.webp)

![stash 在 Git Graph 中的显示](/images/review/git-learning-notes/image-20260607125535624.webp)
...
![reset 三种模式对比](/images/review/git-learning-notes/image-20260607135909909.webp)
...
![语义化版本号](/images/review/git-learning-notes/image-20260523163149500.webp)
...
![渐进稳定分支结构](/images/review/git-learning-notes/image-20260523164840855.webp)

![分支稳定性流向](/images/review/git-learning-notes/image-20260523171042629.webp)
...
![Team Workflow](/images/review/git-learning-notes/image-20260704164645579.webp)

## IM-PR Workflow（Pull Request 工作流）

PR（Pull Request）工作流：开发者在自己的分支/fork 上完成开发后，发起 PR 请求合并到主分支。团队在 PR 上进行 Code Review，审核通过后合并。

![PR Workflow](/images/review/git-learning-notes/image-20260704164806638.webp)
...
![Fork Workflow](/images/review/git-learning-notes/image-20260704165121486.webp)
...
![SSH 认证流程](/images/review/git-learning-notes/image-20260710165330313.webp)
...
![HTTPS 认证](/images/review/git-learning-notes/image-20260711093759433.webp)
